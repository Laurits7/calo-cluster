...
from calo_cluster.datasets.mixins.hcal_tt import HCalTTDataModuleMixin, HCalTTMixin
...
@dataclass
class HCalTTOffsetDataset(
    SparseDatasetMixin, OffsetDatasetMixin, ScaledDatasetMixin, HCalTTMixin
):
    pass


@dataclass
class HCalTTDataModule(
    SparseDataModuleMixin, ScaledDataModuleMixin, HCalTTDataModuleMixin
):
...
@dataclass
class HCalTTOffsetDataModule(
    SparseDataModuleMixin,
    OffsetDataModuleMixin,
    ScaledDataModuleMixin,
    HCalTTDataModuleMixin,
):
